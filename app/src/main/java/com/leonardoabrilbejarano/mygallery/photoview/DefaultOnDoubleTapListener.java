...
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
     ...
     */
    public DefaultOnDoubleTapListener(PhotoViewAttacher photoViewAttacher , final LinearLayout fr) {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        /*
        LinearLayout fl = photoViewAttacher.getLinearLayout();
        if(DefaultOnDoubleTapListener.hidebar){
            DefaultOnDoubleTapListener.hidebar = !DefaultOnDoubleTapListener.hidebar;
